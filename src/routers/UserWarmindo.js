...
Router.get(
  "/getallUserWarmindo",
  jwtAuthenticate,
  UserWarmindoController.getUserWarmindo
);
...
Router.delete(
  "/deleteUserWarmindo",
  jwtAuthenticate,
  UserWarmindoController.deleteUserWarmindo
);
Router.patch(
  "/updatePassword",
  jwtAuthenticate,
  UserWarmindoController.editUserWarmindo
);
Router.patch(
  "/editStatusUser",
  jwtAuthenticate,
  UserWarmindoController.editStatusUser
);
